...
export default {
  ...
  computed: {
    ...
    //pasar los precos venidos a historial a float t que muestresn dos numeros despues de la coma
    fixedHistory() {
      return this.history.map((h) => parseFloat(h.priceUsd).toFixed(2));
    },
    //sumar todos los priceUsd
    sum() {
    ...
    //calcula el minimo de todos los valores
    min() {
      return Math.min(...this.fixedHistory);
    },
    //calcula el maximo de todos los valores
    max() {
